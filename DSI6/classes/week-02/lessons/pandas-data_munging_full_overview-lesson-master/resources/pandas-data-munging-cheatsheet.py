# -*- coding: utf-8 -*-
"""
Created on Tue Aug  9 10:50:58 2016
...
users = pd.read_table('https://raw.githubusercontent.com/justmarkham/DAT8/master/data/u.user', sep='|', header=None, names=user_cols, index_col='user_id')
